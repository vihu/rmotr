"""
The objective of this assignment is to write a factorial function
...
Finally, the `factorial` function will get a number and using both helper
functions will compute the answer. The `factorial` function can have just
1 line.

Use the tests to see the complete specification of what you're required to
write.
